...
@section('content')
    ...
    <div class="card mt-2 w-100 w-lg-50">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('priceType.update', $priceType->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="row">
                            <div class="col-12 mb-3 mt-1">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Price Type Name" value="{{ $priceType->name }}">
                            </div>
                        </div>
